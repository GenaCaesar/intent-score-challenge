...
public class MainActivity extends AppCompatActivity {
    ...
    public void SubmitTeam(View view) {
        ...
        if(homeUri != null){
            ...
            Toast.makeText(this, "Add Image first "+ home +" It used to be!", Toast.LENGTH_SHORT).show();
        }
        ...
        if(awayUri != null){
            ...
            Toast.makeText(this, "Add Image first "+ away +" It used to be!", Toast.LENGTH_SHORT).show();
        }
